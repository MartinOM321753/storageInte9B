...
public class BeanUser {
    ...
    public BeanUser(Long id, String uuid, String username, String password, String fullName, String email, Boolean active, LocalDateTime createdAt, Rol rol, Storage storage) {
        this.id = id;
        this.uuid = uuid;
